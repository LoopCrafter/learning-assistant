    ...
    <div className="min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-6">
          ...
          (dashboardData.recentActivities.documents.length > 0 ||
            dashboardData.recentActivities.quizzes.length > 0) ? (
              ...
              {[
                ...(dashboardData.recentActivities.documents || []).map(
                  (doc) => ({
                    ...
                    timestamp: new Date(doc.lastAccessedAt).getTime(),
                ...
                .map((activity, index) => (
                  ...
                  >
                    ...
                    {activity.link && (
                      <a
                        href={activity.link}
                        className="ml-4 px-4 py-2 text-xs font-semibold text-emerald-600 hover:text-emerald-700 hover:bg-emerald-50 rounded-lg transition duration-200 whitespace-nowrap "
                      >
                        View
                      </a>
                    )}
            ...
            <div className="text-center py-12">
              <div className="inline-flex justify-center items-center w-16 h-16 rounded-2xl bg-slate-100 mb-4">
