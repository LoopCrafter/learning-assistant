...
import { formatFileSize, formatRelativeTime } from "@src/utils";
      ...
      <div>
        <div className="flex items-start justify-between gap-3 mb-4 ">
          ...
          <button
            ...
            className="opacity-0 group-hover:opacity-100 size-8 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200"
          >
