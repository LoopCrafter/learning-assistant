...
const EmptyState: React.FC<QuizManagerProps> = ({
  title,
  description,
  onActionClick,
  buttonText,
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6  text-center bg-linear-to-br from-slate-50/50 to-white border-2 border-dashed border-slate-200 rounded-3xl">
      <div className="inline-flex items-center justify-center size-16 rounded-2xl bg-linear-to-br from-slate-100 to-slate-200/50 mb-6">
        <FileText className="size-8 text-slate-400" strokeWidth={2} />
      </div>
